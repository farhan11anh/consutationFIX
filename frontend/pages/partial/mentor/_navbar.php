<div class="bg-white w-full h-[50px] flex content-center px-10  rounded-xl">
                ...
                <ul class="flex items-center gap-x-8">
                    <li class="status <?= $_SERVER['REQUEST_URI'] == '/websocket/web-chat-room/frontend/pages/mentor_approve.php' ?  $classActive : $classDiss?>">
                        <a href="mentor_approve.php"><p>Status Konsultasi </p></a>
                    </li>
                    <a href="mentor.php"><li class="permohonan <?= $_SERVER['REQUEST_URI'] == '/websocket/web-chat-room/frontend/pages/mentor.php' ? $classActive : $classDiss?>">
                         Permohonan Konsultasi 
                    </li></a>   
                    <a href="mentor_set_schedule.php"><li class="jadwal <?= $_SERVER['REQUEST_URI'] == '/websocket/web-chat-room/frontend/pages/mentor_set_schedule.php' ?  $classActive : $classDiss?>">
